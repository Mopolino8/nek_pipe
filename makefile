### makefile automatically created by makenek 06/27/2016 16:20:18 ###
BINNAME=nek5000
LIBNAME=libnek5000.a
CASENAME:=couette
CASEDIR:=/nfs2/jcanton/anl/nek_couette
S:=/nfs2/jcanton/software/nek5/trunk/nek
S2:=/nfs2/jcanton/software/nek5/trunk/nek/cmt
J:=$S/jl
OPT_INCDIR:=./
OBJDIR=obj
IFMPI:=true
...
OPT_FLAGS_STD=
USR:=chkpoint.o IO_tools.o uparam.o
USR_LFLAGS:=
IFVISIT=
VISIT_IFLAGS=
VISIT_LFLAGS=
